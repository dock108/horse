...
"""
        ...
        if alerts:
            first_time = alerts[0].triggered_at.strftime('%H:%M') if alerts[0].triggered_at else 'N/A'
            last_time = alerts[-1].triggered_at.strftime('%H:%M') if alerts[-1].triggered_at else 'N/A'
